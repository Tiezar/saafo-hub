    ...
    return (
      <div className="page">
        ...
        <h2 style={{ fontSize: 15, fontWeight: 700, marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8 }}>
          <Clock size={15} style={{ color: 'var(--color-primary)' }} /> Provas Salvas
        </h2>
            ...
            {currentEval && (
              <div style={{ marginTop: 18 }}>
                ...
                <div style={{ padding: '10px 14px', borderRadius: 8, background: 'var(--bg-surface)', borderLeft: '3px solid var(--color-primary)', marginBottom: 14 }}>
                  <div style={{ fontSize: 10, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em', color: 'var(--color-primary)', marginBottom: 4 }}>Gabarito</div>
